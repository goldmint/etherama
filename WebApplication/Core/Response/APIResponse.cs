...
namespace Etherama.WebApplication.Core.Response {
	...
	public class APIResponse : Microsoft.AspNetCore.Mvc.ObjectResult {
		...
		/// </summary>
		public static APIResponse BadRequest(IEnumerable<Etherama.WebApplication.Models.API.BaseValidableModel.Error> errorFields, string format = null, params object[] args) {
		...
		public static APIResponse BadRequest(string errorField, string errorDescription, string format = null, params object[] args) {
			return BadRequest(
				new[] { new Etherama.WebApplication.Models.API.BaseValidableModel.Error() {
					Field = errorField,
