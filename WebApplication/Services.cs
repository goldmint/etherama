		...
		public IServiceProvider ConfigureServices(IServiceCollection services) {
			...
			if (!_environment.IsProduction()) {
				services.AddSwaggerGen(opts => {
					...
					opts.IncludeXmlComments(System.IO.Path.Combine(Microsoft.Extensions.PlatformAbstractions.PlatformServices.Default.Application.ApplicationBasePath, "Etherama.WebApplication.xml"));
